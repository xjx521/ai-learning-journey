...
if __name__ == "__main__":
    print(semantic_retrieve(query="我入职两年有几天年假？", docs=knowledge))
    print(semantic_retrieve(query="工资什么时候发？", docs=knowledge))
    print(semantic_retrieve(query="最近累，想出去放松两天", docs=knowledge))
    print(semantic_retrieve(query="团建花钱公司报销吗？ ", docs=knowledge))
