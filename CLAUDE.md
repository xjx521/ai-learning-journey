...
当前阶段：第一阶段 | 当前进度：Day 15 已完成 | LeetCode：0题 | 最后更新：2026-07-12
...
| 07-12 | Day15 | 2/2 | 良好 | 面向对象基础——类与对象。day15-1：Turtle类理解__init__构造方法、实例属性vs类属性、self的含义。homework15-1：Student类（__init__默认参数None避免可变陷阱、add_score/appen d、average/ZeroDivisionError、introduce调用方法加()）。homework15-2：BankAccount类（私有属性_balance约定、deposit/withdraw/get_balance封装） |
