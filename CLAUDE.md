...
当前阶段：第三阶段（加速计划） | 当前进度：Day 43 开始（8/12） | LeetCode：0题 | 最后更新：2026-08-12
...
## 二、动手实验（N 小时，核心）
实验 A/B/C：步骤 + 留空记录表格 + 观察思考问题（破坏性/对比实验优先）
...
**吴恩达课程（概念预习）**：
- LLM 课：https://www.bilibili.com/video/BV1sMEyzhEM3/（59集，只看 LLM 基础/Transformer/生成配置/能力边界等应用相关章节，**跳过**微调/LoRA/RLHF/PPO 训练专题）
